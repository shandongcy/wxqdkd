<?php $this->load->view('admin/header'); ?>
  ...
  <section id="content">
    <section class="main padder">
      ...
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            <header class="panel-heading">代寄订单 <i class="icon-info-sign text-muted" data-toggle="popover" data-html="true" data-placement="top" data-content="未接单列表." title="" data-trigger="hover" ></i> </header>
            <div class="pull-out">
  ...
  <script type="text/javascript">
    var accept = function(e){
      ...
      $.ajax({
        'url':'/admin/admin/accept_dkd_order',
        'data':{
          'id':id
        },
        'type':"post",
  ...
  <script src="/recources/admin/js/djkd.data.js"></script>
